                    ...
                    builder: (context, filterstate) {
                      return BlocBuilder<ProductBloc, ProductState>(
                          builder: (context, state) {
                            ...
                            // state.products.where((element) => element.categories.any((catid) =>  filterstate.categories.map((category) => category.id).contains(catid))).toList();

                            if(filterstate.keyword != null && filterstate.keyword!.isNotEmpty){
                              listoFProduct = state.products.where((element) => element.name.toUpperCase().contains(filterstate.keyword!.toUpperCase().toString())).toList();
                            }


                            return listoFProduct.isEmpty ? SingleChildScrollView(
                              child: Column(
                                mainAxisAlignment: MainAxisAlignment.center,
                                children: [
                                    Image.asset('assets/status_image/no-connection.png'),
